...
def load_file(
    ...
    file_infos[id] = {
        'local_pattern': os.path.join(local_data_dir,rbspx,'spice_var','%Y',base_name),
        'remote_pattern': os.path.join(remote_data_dir,rbspx,'ephemeris','efw-ephem','%Y',base_name),
    }
    ...
    file_infos[id] = {
        ...
        'valid_range': system.prepare_time_range(valid_range(id, probe)),
    }
    ...
    file_infos[id] = {
        ...
        'valid_range': system.prepare_time_range(valid_range('e_spinfit', probe)),
    }
