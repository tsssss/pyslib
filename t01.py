...
# apprc tested, pass.
# full_rc, b[xyz]src has difference, cleared.
# rc_shield, fs[xyz] has difference, cleared.
...
def deformed(iopt,ps,x,y,z):
    ...
    Calculates gsm components of two unit-amplitude tail field modes, taking into account
        both effects of dipole tilt: warping in y-z (done by the s/r warped) and bending
